...
system and the Python, NumPy, and `pkg_deleteme` versions you are using.

Contributing Code and Documentation
-----------------------------------

So you are interested in contributing to the pkg_deleteme Project?  Excellent!
...
from GitHub users' forks of pkg_deleteme If you are new to this
